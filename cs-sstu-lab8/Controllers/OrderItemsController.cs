...
namespace cs_sstu_lab8.Controllers
{
    ...
    public class OrderItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Amount,Price,ProductId,OrderId")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Amount,Price,ProductId,OrderId")] OrderItem orderItem)
        {
            if (id != orderItem.Id)
            {
                return NotFound();
